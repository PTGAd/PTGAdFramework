...
## Topon支持
支持Topon的聚合请求广告（支持信息流，开屏，横幅），可在Topon后台配置广告请求的适配器，具体可联系Fancy 商务配置,技术接入需导入
...
| 10008 | 广告位 ID 为空 |
| 10009 | 广告位 ID 不合法 |
| 10010 | 广告初始化参数不合法，比如 size |
| 10011 | 广告加载异常，第三方消耗方广告加载失败 |
| 10012 | 没有广告容器 |
| 10013 | 代码中没有对应消耗方，适配器为空 |
| 10014 | 资源加载错误 |
| 10015 | 渲染错误 |
| 10016 | 广告过期 |
| 10017 | 广告展示异常 |
...
| 10026 | 广告价格低于底价 |
| 10027 | 广告 Style 不合法 |
| 10028 | 广告位 id 所属类型和广告 API 类型不匹配 |
| 10029 | 请求 URL 为空 |
| 10030 | POST data 为空 |
| 10031 | AES 密钥为空 |
| 10032 | URL 格式错误 |
...
| 10039 | 序列化异常 |
| 10040 | 广告被策略过滤，不允许展示 |
| 10041 | Banner PreRenderView 不存在 |
| 10042 | 传入的 VC 不存在 |
| 10043 | 有 presentedViewController 无法展示 |
| 10044 | 不支持的广告形式 |
| 10045 | 下载 apk 超时 |
